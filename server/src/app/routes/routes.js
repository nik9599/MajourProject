...
const { signUpUser, loginUser , getByUserId } = require("../controller/auth-controller.js");
...
Routes.get("/increseQuantityOffline/:product_id" , tokenValidator , increasProductQuantityOffline);
Routes.get("/decreaseQuantityOffline/:product_id" , tokenValidator , decreseProductQuantityOffline)
